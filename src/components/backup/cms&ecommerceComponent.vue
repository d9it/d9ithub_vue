<template>
	<div class="inner_pages">
		...
		<div class="cms_ecommerce all_services">
			<div class="col-sm-6 left_services">
				<div class="services_text">
					<h2>CMS & Ecommerce Services</h2>
					<ul>
						<li><a class="development_menu_tab" href="#magento">Magento Development</a></li>
						<li><a class="development_menu_tab" href="#wordpress">Wordpress Development</a></li>
						<li><a class="development_menu_tab" href="#ecommerce">Ecommerce Development</a></li>
		...
		<!-- ecommerce development  -->
			<div class="ecommerce all_services" id="ecommerce">
					<div class="col-sm-6 right_services"><div class="bg_img"></div></div>
					<div class="col-sm-6 left_services">
							<div class="services_text">
