    ...
    <div>
        ...
        <div class="home_about_us home_testimonial">
            <div class="row m-0">
                ...
                <div class="col-lg-6 col-12 about_us">
                    <div class="home_abouttext">
                        <div class="middle_heading">Our Clients Love</div>
                        <div id="client" class="carousel slide" data-ride="carousel">
                            ...
                            <ul class="carousel-indicators">
                                ...
                                <li data-target="#client" data-slide-to="4"></li>
                                <li data-target="#client" data-slide-to="5"></li>
                                <li data-target="#client" data-slide-to="6"></li>
                            </ul>
                        </div>
                    </div>
                </div>
            </div>
            <div class="decor-text decor-text-1">Clients</div>
        </div>
    </div>
</template>
